...
function startGame() {
    myGamePiece = new component(130, 90, "images/balondown1.png", 100 , 120, "image")
...
document.body.addEventListener("keydown", (event) => {
    if(event.code === "Space"){
        ...
        accelerate(-0.1)
        myGamePiece.image.src = "images/balonup1.png"
    }
})
document.body.addEventListener("keyup", (event) => {
    if(event.code === "Space"){
        myGamePiece.speedY = +2
        accelerate(0.1)
        myGamePiece.image.src = "images/balondown1.png"
    }
})